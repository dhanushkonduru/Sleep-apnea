-- Sleep Apnea Detection System Database Schema
...
CREATE TABLE oauth_providers (
    ...
    provider VARCHAR(50) NOT NULL CHECK (provider IN ('google', 'github', 'apple', 'microsoft')),
...
CREATE POLICY "Users can view own apnea events" ON apnea_events
    FOR ALL USING (
        EXISTS (
            ...
            JOIN sessions s ON r.id = reports.session_id
